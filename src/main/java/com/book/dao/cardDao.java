...
public class CardDao {
    ...
    private final static String QUERY_ALL_CARDS_BY_USER_SQL="SELECT card.no AS card_no, bank.name AS bank_no FROM card INNER JOIN bank ON card.bank_id = bank.bank_id WHERE card.user_id = ? ;";
